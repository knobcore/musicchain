...
set -e
cd /mnt/c/Users/lain/blockchain/musicchain_player
...
export MC_LIB_DIR=/mnt/c/Users/lain/blockchain/musicchain/build-linux-sys/Release
...
echo "Find the .AppImage in musicchain_player/build/"
echo "=========================================="
