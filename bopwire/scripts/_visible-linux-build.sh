...
set -e
cd /mnt/c/Users/lain/blockchain/bopwire
...
# the shared libbopwire.so — without -fPIC the linker errors out
# with R_X86_64_PC32 on every libwally internal helper.
rm -f build-linux-sys/CMakeFiles/bopwire.dir/src/audio/multi_decoder.cpp.o \
      build-linux-sys/CMakeFiles/bopwire_static.dir/src/audio/multi_decoder.cpp.o \
      build-linux-sys/CMakeFiles/bopwire.dir/src/api/jsonrpc_server.cpp.o \
      build-linux-sys/CMakeFiles/bopwire_static.dir/src/api/jsonrpc_server.cpp.o \
      2>/dev/null || true
