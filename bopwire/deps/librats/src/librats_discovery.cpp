...
std::string RatsClient::get_discovery_hash() const {
    ...
    // automatic rats-peer-discovery announce). Namespace it with a bopwire-specific
    ...
    static constexpr const char* BOPWIRE_DHT_SALT = "bopwire/overlay/v1:";
    std::string discovery_string = std::string(BOPWIRE_DHT_SALT) +
