...
class NativeLibrary {
  static late BopwireBindings _bindings;
  static late DynamicLibrary _lib;
  static bool _initialized = false;

  static BopwireBindings get bindings {
  ...
  /// need to resolve symbols added to bopwire.h after the generated
  /// BopwireBindings was last regenerated. Prefer `bindings` over
  ...
  static Future<void> initialize() async {
    ...
    _lib = _loadLibrary();
    _bindings = BopwireBindings(_lib);
  ...
  static DynamicLibrary _loadLibrary() {
    if (Platform.isWindows) {
      return DynamicLibrary.open('bopwire.dll');
    } else if (Platform.isMacOS) {
      return DynamicLibrary.open('libbopwire.dylib');
