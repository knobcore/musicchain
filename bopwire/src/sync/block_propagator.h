...
///
/// Wire verbs (all envelopes are bopwire.request JSON):
///
...
public:
    ...
    /// embed in the bopwire.reply. Always returns a body; status
...
private:
    ...
    /// Send a bopwire.request envelope. Fire-and-forget at the
    ...
    /// addresses. Per the bopwire librats patch's ownership
